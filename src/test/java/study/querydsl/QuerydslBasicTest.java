...
public class QuerydslBasicTest {
    ...
    public void resultFetch(){
        ...
        Member fetchOne = queryFactory
                .selectFrom(member)
                .fetchOne();
        System.out.println("fetchOn = " + fetchOne);
    ...
    public void aggregation(){
        ...
        assertThat(tuple.get(member.age.sum())).isEqualTo(46);
        assertThat(tuple.get(member.age.avg())).isEqualTo(11.5);
        assertThat(tuple.get(member.age.max())).isEqualTo(13);
    ...
    public void group() throws Exception{
        ...
        assertThat(teamA.get(member.age.avg())).isEqualTo(10.5);

        assertThat(teamB.get(team.name)).isEqualTo("teamB");
        assertThat(teamB.get(member.age.avg())).isEqualTo(12.5);
     ...
     */
    @Test
    public void join_on_no_reation(){
        em.persist(new Member("teamA"));
        em.persist(new Member("teamB"));
        em.persist(new Member("teamC"));
    ...
    public void complexCase(){
        List<String> result = queryFactory
                .select(new CaseBuilder()
                        ...
                        .when(member.age.between(11, 12)).then("11~12살")
                        .otherwise("기타")
                ).from(member)
                .fetch();
